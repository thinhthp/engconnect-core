...
namespace EngConnect.Repositories.Migrations
{
    ...
    [Migration("20260204170709_AddCallRecordings")]
    partial class AddCallRecordings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EngConnect.Entities.Entities.CallParticipant", b =>
                {
            ...
            modelBuilder.Entity("EngConnect.Entities.Entities.CallSession", b =>
                {
                    b.Property<long>("CallSessionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("CallSessionId"));
                    ...
                    b.Property<bool>("RecordingCompleted")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                    ...
                    b.HasKey("CallSessionId")
                        .HasName("callsession_pkey");

                    b.HasIndex("CalleeId");

                    b.HasIndex("CallerId");

                    b.ToTable("call_session", (string)null);
                });

            modelBuilder.Entity("EngConnect.Entities.Entities.CallSignal", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("SignalId"));
                    ...
                    b.ToTable("call_signal", (string)null);
                });
            ...
            modelBuilder.Entity("EngConnect.Entities.Entities.CallParticipant", b =>
                {
                    b.HasOne("EngConnect.Entities.Entities.CallSession", "CallSession")
            ...
            modelBuilder.Entity("EngConnect.Entities.Entities.CallSession", b =>
                {
                    b.HasOne("EngConnect.Entities.Entities.ApplicationUser", "Callee")
                        .WithMany("IncomingCallSessions")
                        .HasForeignKey("CalleeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("callsession_callee_id_fkey");

                    b.HasOne("EngConnect.Entities.Entities.ApplicationUser", "Caller")
                        .WithMany("OutgoingCallSessions")
            ...
            modelBuilder.Entity("EngConnect.Entities.Entities.CallSignal", b =>
                {
                    ...
                    b.HasOne("EngConnect.Entities.Entities.ApplicationUser", "Receiver")
                        .WithMany("ReceivedCallSignals")
            ...
            modelBuilder.Entity("EngConnect.Entities.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Navigation("IncomingCallSessions");

                    b.Navigation("Orders");

                    b.Navigation("OutgoingCallSessions");

                    b.Navigation("ReceivedCallSignals");

                    b.Navigation("RefreshTokens");

                    b.Navigation("Reviews");

                    b.Navigation("SentCallSignals");
